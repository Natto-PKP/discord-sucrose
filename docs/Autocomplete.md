...
- [`BaseInteraction`](../wiki/BaseInteraction)<{ `interaction`: `Discord.AutocompleteInteraction`  }\>
...
- [body](../wiki/Autocomplete#body)
- [conditions](../wiki/Autocomplete#conditions)
- [cooldowns](../wiki/Autocomplete#cooldowns)
- [custom](../wiki/Autocomplete#custom)
- [description](../wiki/Autocomplete#description)
- [exec](../wiki/Autocomplete#exec)
- [hooks](../wiki/Autocomplete#hooks)
- [permissions](../wiki/Autocomplete#permissions)
- [tags](../wiki/Autocomplete#tags)
...
[typings/index.d.ts:600](https://github.com/Natto-PKP/discord-sucrose/blob/a2c6566/typings/index.d.ts#L600)
